            ...
            {inviteCode ? (
              <>
                ...
                <div className="space-y-3">
                  <button className="w-full py-2.5 bg-[var(--primary)] hover:bg-[var(--primary-dark)] transition rounded-xl shadow-md font-medium text-white flex items-center justify-center space-x-2">
                  ...
                  <button className="w-full py-2.5 bg-[var(--accent)] hover:bg-[var(--accent-dark)] transition rounded-xl shadow-md font-medium flex items-center justify-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
